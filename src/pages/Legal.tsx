...
const content: Record<string, { title: string; body: string[] }> = {
  privacy: {
    ...
    body: [
      "Bueno Exports (\"we\", \"us\") collects personal information you provide during checkout and account creation, including your name, email, phone number, and delivery address.",
  ...
  terms: {
    ...
    body: [
      "By using this website and placing an order, you agree to these Terms of Service.",
  ...
  returns: {
    ...
    body: [
      "We want you to be satisfied with your purchase. If a product arrives damaged, defective, or incorrect, please contact us within 48 hours of delivery with photos of the issue.",
