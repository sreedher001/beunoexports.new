...
-- Re-create the order-placement function to also capture SKU per line item
...
DECLARE
  ...
  _item JSONB; _subtotal NUMERIC := 0; _new_order_id UUID; _new_order_number TEXT; _qty INTEGER;
BEGIN
  ...
  FOR _item IN SELECT * FROM jsonb_array_elements(_items) LOOP
    ...
    INSERT INTO public.order_items (
      order_id, product_id, product_name, product_image, quantity, price, variant_label, sku
    ) VALUES (
